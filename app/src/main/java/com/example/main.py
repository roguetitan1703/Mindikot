...
# Includes only the viewmodel and ui/screens files being added/modified
updated_files_content = {
    "ui/viewmodel/GameViewModelNsd.kt": """
...
import kotlinx.coroutines.delay // Import delay for coroutine usage
...
fun GameViewModel.startNsdDiscovery() {
    ...
    if (discoveryListener != null) {
         ...
         this@GameViewModel.viewModelScope.launch { // Explicitly use this@GameViewModel
             delay(200)
...
file_path = "ui/viewmodel/GameViewModelNsd.kt"
updated_content = updated_files_content[file_path]
...
path = base_dir / Path(relative_path_str)
